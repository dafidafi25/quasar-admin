<template>
  <div>
    <q-card class="my-card">
      <q-card-section class="text-h6"> Chart Listrik </q-card-section>
...
export default {
  ...
  methods: {
    init() {
      let listrik = document.getElementById("listrik");
      echarts.dispose(listrik);
      let theme = this.model ? "dark" : "light";
      this.area_chart = echarts.init(listrik, theme);
